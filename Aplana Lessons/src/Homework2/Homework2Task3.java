 ...
 * табло отображает «28800» (т.е. остаётся 8 часов), когда времени 14:30 — на табло «9000»
 ...
 * (т.е. рабочий день закончился).
 ...
 Осталось менее часа
 * Created by chelp on 16.03.2017.
 */
public class Homework2Task3 {
    public static void main(String[] args){
Random random=new Random();
int n=random.nextInt(28801);
        if (n==28800) System.out.print(n+"\nОсталось 8 часов");
        if (28800>n&n>=25200) System.out.print(n+"\nОсталось 7 часов");
        if (25200>n&n>=21600) System.out.print(n+"\nОсталось 6 часов");
        if (21600>n&n>=18000) System.out.print(n+"\nОсталось 5 часов");
        if (18000>n&n>=14400) System.out.print(n+"\nОсталось 4 часа");
        if (14400>n&n>=10800) System.out.print(n+"\nОсталось 3 часа");
        if (10800>n&n>=7200) System.out.print(n+"\nОсталось 2 часа");
        if (7200>n&n>=3600) System.out.print(n+"\nОстался 1 час");
        if (3600>n&n>=0) System.out.print(n+"\nОсталось менее часа");
    }
}
